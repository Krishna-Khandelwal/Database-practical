...
def LoginForm():
    ...
    captcha = Label(LoginFrame, text="", font=('times new roman', 18),fg="red")
    captcha.grid(row=4, columnspan=1)
    ...
    lbl_forgetpassword.grid(row=5,columnspan=2, pady=4)
...
def generate_first_image_login():
    ...
    Show_image = tkinter.Label(LoginFrame, image = imgtk).place(x = 650, y = 500)
...
def regenerate_image_captcha_login():
    ...
    imgtk = ImageTk.PhotoImage(image = im)
    Show_image = tkinter.Label(LoginFrame, image = imgtk).place(x = 650, y = 500)
# =======================================Register Screen================&=============CAPTCHA FUNCTION ==================================
...
def generate_first_image():
    ...
    imgtk = ImageTk
    imgtk = ImageTk.PhotoImage(image = im)
    Show_image = tkinter.Label(RegisterFrame, image = imgtk).place(x = 650, y = 500)
